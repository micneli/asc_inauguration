let students = [
  {
    ...
    age: "42 ans",
    presentation: "Demain nous appartient",
  ...
  },
  {
    ...
    softSkills: ["Autonome ", "Curieux ", "Créatif", "Sportif", "Organisé"],
  ...
  },
  {
    ...
    surname: "Irina",
    age: "40 ans",
    presentation: "Je parle plusieurs langues: Français, Anglais, Russe, Ukrainien",
    passion: "être en harmonie avec soi-même et avec les autres",
    ...
    passionFun: "Voyager, prendre de jolies photos, la nature"
  },
  {
    name: "Isabelle Hennes",
    surname: "Zabou",
    age: "32 ans",
    presentation: "Je  continue à développer mes compétences de community manager afin de pouvoir travailler en tant que développeur web/community manager." ,
    passion: "les réseaux sociaux",
  ...
  },
  {
    ...
    surname: "Jojo",
    age: "34 ans",
    presentation: "Tout métier qui ne fait pas oublier le travail est un ésclavage",
  ...
  },
  {
    ...
    passion: "Musique, photo et vidéo",
    ...
    passionFun: "Les voyages, , Harry Potter, les carnavals, et les amis"
  },
  {
    name: "Julie Mulot",
...
$('#myCarousel').on('slide.bs.carousel', function onSlide(ev) {
   ...
   switch (id) {
      ...
      case 1:
         ...
         presentation1[0].textContent = students[0].presentation;
         ...
         passionFun[0].textContent = "Passion : " + students[0].passionFun;
         break;
      ...
      case 2:
         ...
         passionFun[1].textContent = "Passion : " + students[1].passionFun;
         break;
      ...
      case 3:
         ...
         passionFun[2].textContent = "Passion : " + students[2].passionFun;
         break;
      ...
      case 4:
         ...
         passionFun[3].textContent = "Passion : " + students[3].passionFun;
         break;
      ...
      case 5:
         ...
         passionFun[4].textContent = "Passion : " + students[4].passionFun;
         break;
      ...
      case 6:
         ...
         passionFun[5].textContent = "Passion : " + students[5].passionFun;
         break;
      ...
      case 7:
         ...
         passionFun[6].textContent = "Passion : " + students[6].passionFun;
         break;
      ...
      case 8:
         ...
         passionFun[7].textContent = "Passion : " + students[7].passionFun;
         break;
      ...
      case 9:
         ...
         passionFun[8].textContent = "Passion : " + students[8].passionFun;
         break;
      ...
      case 11:
         ...
         passionFun[10].textContent = "Passion : " + students[10].passionFun;
         break;
      ...
      case 12:
         ...
         passionFun[11].textContent = "Passion : " + students[11].passionFun;
         break;
      ...
      case 13:
         ...
         passionFun[12].textContent = "Passion : " + students[12].passionFun;
         break;
      ...
      case 14:
         ...
         passionFun[13].textContent = "Passion : " + students[13].passionFun;
         break;
      ...
      case 15:
         ...
         passionFun[14].textContent = "Passion : " + students[14].passionFun;
         break;
      ...
      case 16:
         ...
         passionFun[15].textContent = "Passion : " + students[15].passionFun;
         break;
      ...
      case 17:
         ...
         passionFun[16].textContent = "Passion : " + students[16].passionFun;
         break;
      ...
      case 18:
         ...
         passionFun[17].textContent = "Passion : " + students[17].passionFun;
         break;

...
$('#myCarousel').on('slide.bs.carousel', function onSlide(ev) {
  ...
  switch (id) {
    ...
    case 1:
      ...
      devise[0].textContent = students[0].devise;
      passionFun[0].textContent = students[0].passionFun;
      break;
    ...
    case 2:
      ...
      devise[1].textContent = students[1].devise;
      passionFun[1].textContent = students[1].passionFun;
      break;
